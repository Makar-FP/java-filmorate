...
class ValidationTest {
    ...
    void validateFilmNameIsEmptyShouldThrowException() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> controller.createFilm(film));
    ...
    void validateUserLoginIsEmptyShouldThrowException() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> controller.createUser(user));
